 ...
 */
public class TenantsTest extends JbpmJUnitBaseTestCase {
	int numOfTenants=2;
	int numOfHosts=4;
	...
	int minNumOfHosts=2;//minNumOfHosts provide the service
	 ...
	 // test InsuranceClaim5  with parallel sessions
		...
		public void testProcess() throws IOException{
			...
			KernelManagment km=new KernelManagment(numOfTenants,numOfHosts,numOfServices,MaxNumOfUsers,maxNumOfHosts,minNumOfHosts);
